          ...
          module Rest
            ...
            class ServiceStub
              ...
              def delete request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::DeleteRegionNotificationEndpointRequest.encode_json(request_pb)
              ...
              def get request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::GetRegionNotificationEndpointRequest.encode_json(request_pb)
                ...
                ::Google::Cloud::Compute::V1::NotificationEndpoint.decode_json result_json[:body]
              end
              ...
              def insert request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::InsertRegionNotificationEndpointRequest.encode_json(request_pb)
              ...
              def list request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::ListRegionNotificationEndpointsRequest.encode_json(request_pb)
                ...
                ::Google::Cloud::Compute::V1::NotificationEndpointList.decode_json result_json[:body]
              end
            end
          end
        end
