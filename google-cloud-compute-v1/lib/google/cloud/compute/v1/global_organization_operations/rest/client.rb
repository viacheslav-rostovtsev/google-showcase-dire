        ...
        module GlobalOrganizationOperations
          module Rest
            ...
            class Client
              ...
              # ## Examples
              #
              # To create a new GlobalOrganizationOperations REST client with the default
              # configuration:
              #
              #     client = ::Google::Cloud::Compute::V1::GlobalOrganizationOperations::Rest::Client.new
              #
              # To create a new GlobalOrganizationOperations REST client with a custom
              # configuration:
              #
              ...
              def delete request, options = nil
                ...
                @global_organization_operations_stub.delete request, options: options do |response, env|
              ...
              def get request, options = nil
                ...
                @global_organization_operations_stub.get request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def list request, options = nil
                ...
                @global_organization_operations_stub.list request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
