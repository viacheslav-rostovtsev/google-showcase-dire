          ...
          module Rest
            ...
            class ServiceStub
              ...
              def delete request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::DeleteGlobalOrganizationOperationRequest.encode_json(request_pb)
                ...
                ::Google::Cloud::Compute::V1::DeleteGlobalOrganizationOperationResponse.decode_json result_json[:body], { ignore_unknown_fields: true }
              end
              ...
              def get request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::GetGlobalOrganizationOperationRequest.encode_json(request_pb)
              ...
              def list request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::ListGlobalOrganizationOperationsRequest.encode_json(request_pb)
