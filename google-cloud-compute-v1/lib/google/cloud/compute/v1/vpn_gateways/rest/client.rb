    ...
    module Compute
      module V1
        module VpnGateways
          module Rest
            ##
            # REST client for the VpnGateways service.
            #
            # The VpnGateways API.
            #
            class Client
              ...
              ##
              # Configure the VpnGateways Client class.
              #
              ...
              ##
              # Configure the VpnGateways Client instance.
              #
              ...
              #   {::Google::Cloud::Compute::V1::AggregatedListVpnGatewaysRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::AggregatedListVpnGatewaysRequest, ::Hash]
              ...
              def aggregated_list request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Compute::V1::AggregatedListVpnGatewaysRequest

                @vpn_gateways_stub.aggregated_list request, options: options do |response, env|
              ...
              #   {::Google::Cloud::Compute::V1::DeleteVpnGatewayRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::DeleteVpnGatewayRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              def delete request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Compute::V1::DeleteVpnGatewayRequest

                @vpn_gateways_stub.delete request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              #   {::Google::Cloud::Compute::V1::GetVpnGatewayRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::GetVpnGatewayRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              def get request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Compute::V1::GetVpnGatewayRequest

                @vpn_gateways_stub.get request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              #   {::Google::Cloud::Compute::V1::GetStatusVpnGatewayRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::GetStatusVpnGatewayRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              def get_status request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Compute::V1::GetStatusVpnGatewayRequest

                @vpn_gateways_stub.get_status request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              #   {::Google::Cloud::Compute::V1::InsertVpnGatewayRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::InsertVpnGatewayRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              def insert request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Compute::V1::InsertVpnGatewayRequest

                @vpn_gateways_stub.insert request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              #   {::Google::Cloud::Compute::V1::ListVpnGatewaysRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::ListVpnGatewaysRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              def list request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Compute::V1::ListVpnGatewaysRequest

                @vpn_gateways_stub.list request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              #   {::Google::Cloud::Compute::V1::SetLabelsVpnGatewayRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::SetLabelsVpnGatewayRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              def set_labels request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Compute::V1::SetLabelsVpnGatewayRequest

                @vpn_gateways_stub.set_labels request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              #   {::Google::Cloud::Compute::V1::TestIamPermissionsVpnGatewayRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::TestIamPermissionsVpnGatewayRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              def test_iam_permissions request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Compute::V1::TestIamPermissionsVpnGatewayRequest

                @vpn_gateways_stub.test_iam_permissions request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
