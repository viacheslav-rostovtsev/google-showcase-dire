        ...
        module Zones
          module Rest
            ...
            class Client
              ...
              # ## Example
              #
              # To modify the configuration for all Zones clients:
              #
              ...
              # ## Examples
              #
              # To create a new Zones REST client with the default
              # configuration:
              #
              #     client = ::Google::Cloud::Compute::V1::Zones::Rest::Client.new
              #
              # To create a new Zones REST client with a custom
              # configuration:
              #
              ...
              def get request, options = nil
                ...
                @zones_stub.get request, options: options do |response, env|
              ...
              def list request, options = nil
                ...
                @zones_stub.list request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
