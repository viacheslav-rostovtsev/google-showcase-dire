          ...
          module Rest
            ...
            class ServiceStub
              ...
              def get request_pb, options:, &block
                ...
                ::Google::Cloud::Compute::V1::InterconnectLocation.decode_json result_json[:body], { ignore_unknown_fields: true }
              end
              ...
              def list request_pb, options:, &block
                ...
                ::Google::Cloud::Compute::V1::InterconnectLocationList.decode_json result_json[:body], { ignore_unknown_fields: true }
              end
            end
          end
        end
