        ...
        module TargetSslProxies
          module Rest
            ...
            class Client
              ...
              #   {::Google::Cloud::Compute::V1::DeleteTargetSslProxyRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::DeleteTargetSslProxyRequest, ::Hash]
              ...
              def delete request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Compute::V1::DeleteTargetSslProxyRequest

                @target_ssl_proxies_stub.delete request, options: options do |response, env|
              ...
              #   {::Google::Cloud::Compute::V1::GetTargetSslProxyRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::GetTargetSslProxyRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              def get request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Compute::V1::GetTargetSslProxyRequest

                @target_ssl_proxies_stub.get request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #   {::Google::Cloud::Compute::V1::InsertTargetSslProxyRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::InsertTargetSslProxyRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              def insert request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Compute::V1::InsertTargetSslProxyRequest

                @target_ssl_proxies_stub.insert request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #   {::Google::Cloud::Compute::V1::ListTargetSslProxiesRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::ListTargetSslProxiesRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              def list request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Compute::V1::ListTargetSslProxiesRequest

                @target_ssl_proxies_stub.list request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #
              # @overload set_backend_service(request, options = nil)
              #   Pass arguments to `set_backend_service` via a request object, either of type
              #   {::Google::Cloud::Compute::V1::SetBackendServiceTargetSslProxyRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::SetBackendServiceTargetSslProxyRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload set_backend_service(project: nil, request_id: nil, target_ssl_proxies_set_backend_service_request_resource: nil, target_ssl_proxy: nil)
              ...
              def set_backend_service request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Compute::V1::SetBackendServiceTargetSslProxyRequest

                @target_ssl_proxies_stub.set_backend_service request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #
              # @overload set_proxy_header(request, options = nil)
              #   Pass arguments to `set_proxy_header` via a request object, either of type
              #   {::Google::Cloud::Compute::V1::SetProxyHeaderTargetSslProxyRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::SetProxyHeaderTargetSslProxyRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload set_proxy_header(project: nil, request_id: nil, target_ssl_proxies_set_proxy_header_request_resource: nil, target_ssl_proxy: nil)
              ...
              def set_proxy_header request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Compute::V1::SetProxyHeaderTargetSslProxyRequest

                @target_ssl_proxies_stub.set_proxy_header request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #   {::Google::Cloud::Compute::V1::SetSslCertificatesTargetSslProxyRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::SetSslCertificatesTargetSslProxyRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload set_ssl_certificates(project: nil, request_id: nil, target_ssl_proxies_set_ssl_certificates_request_resource: nil, target_ssl_proxy: nil)
              ...
              def set_ssl_certificates request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Compute::V1::SetSslCertificatesTargetSslProxyRequest

                @target_ssl_proxies_stub.set_ssl_certificates request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #   {::Google::Cloud::Compute::V1::SetSslPolicyTargetSslProxyRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::SetSslPolicyTargetSslProxyRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload set_ssl_policy(project: nil, request_id: nil, ssl_policy_reference_resource: nil, target_ssl_proxy: nil)
              ...
              def set_ssl_policy request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Compute::V1::SetSslPolicyTargetSslProxyRequest

                @target_ssl_proxies_stub.set_ssl_policy request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #
              # This class represents the configuration for TargetSslProxies REST,
              ...
              #
              #     ::Google::Cloud::Compute::V1::TargetSslProxies::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              # To apply the above configuration only to a new client:
              #
              #     client = ::Google::Cloud::Compute::V1::TargetSslProxies::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
