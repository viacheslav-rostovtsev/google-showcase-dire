          ...
          module Rest
            ...
            class Client
              ...
              def initialize
                ...
                @region_instance_groups_stub = ::Google::Cloud::Compute::V1::RegionInstanceGroups::Rest::ServiceStub.new(
              ...
              def get request, options = nil
                ...
                @region_instance_groups_stub.get request, options: options do |response, env|
              ...
              def list request, options = nil
                ...
                @region_instance_groups_stub.list request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def list_instances request, options = nil
                ...
                @region_instance_groups_stub.list_instances request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def set_named_ports request, options = nil
                ...
                @region_instance_groups_stub.set_named_ports request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
