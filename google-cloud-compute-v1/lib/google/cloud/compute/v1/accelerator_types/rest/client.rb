          ...
          module Rest
            ...
            class Client
              ...
              def aggregated_list request, options = nil
                ...
                @accelerator_types_stub.aggregated_list request, options: options do |response, env|
              ...
              def get request, options = nil
                ...
                @accelerator_types_stub.get request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def list request, options = nil
                ...
                @accelerator_types_stub.list request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
