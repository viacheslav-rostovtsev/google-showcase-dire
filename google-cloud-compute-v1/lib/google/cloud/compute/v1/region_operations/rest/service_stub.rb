          ...
          module Rest
            ...
            class ServiceStub
              ...
              def delete request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::DeleteRegionOperationRequest.encode_json(request_pb)
                ...
                ::Google::Cloud::Compute::V1::DeleteRegionOperationResponse.decode_json result_json[:body], { ignore_unknown_fields: true }
              end
              ...
              def get request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::GetRegionOperationRequest.encode_json(request_pb)
              ...
              def list request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::ListRegionOperationsRequest.encode_json(request_pb)
              ...
              def wait request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::WaitRegionOperationRequest.encode_json(request_pb)
