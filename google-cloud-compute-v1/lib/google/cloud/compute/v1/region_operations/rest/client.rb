        ...
        module RegionOperations
          module Rest
            ...
            class Client
              ...
              #   {::Google::Cloud::Compute::V1::DeleteRegionOperationRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::DeleteRegionOperationRequest, ::Hash]
              ...
              def delete request, options = nil
                ...
                @region_operations_stub.delete request, options: options do |response, env|
              ...
              #   {::Google::Cloud::Compute::V1::ListRegionOperationsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::ListRegionOperationsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              def list request, options = nil
                ...
                @region_operations_stub.list request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              #   {::Google::Cloud::Compute::V1::WaitRegionOperationRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::WaitRegionOperationRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              def wait request, options = nil
                ...
                @region_operations_stub.wait request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
