          ...
          module Rest
            ...
            class Client
              ...
              def delete request, options = nil
                ...
                @external_vpn_gateways_stub.delete request, options: options do |response, env|
              ...
              def get request, options = nil
                ...
                @external_vpn_gateways_stub.get request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              def insert request, options = nil
                ...
                @external_vpn_gateways_stub.insert request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              def list request, options = nil
                ...
                @external_vpn_gateways_stub.list request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              def set_labels request, options = nil
                ...
                @external_vpn_gateways_stub.set_labels request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              def test_iam_permissions request, options = nil
                ...
                @external_vpn_gateways_stub.test_iam_permissions request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
