        ...
        module MachineTypes
          module Rest
            ...
            class Client
              ...
              # ## Example
              #
              # To modify the configuration for all MachineTypes clients:
              #
              ...
              # ## Examples
              #
              # To create a new MachineTypes REST client with the default
              # configuration:
              #
              #     client = ::Google::Cloud::Compute::V1::MachineTypes::Rest::Client.new
              #
              # To create a new MachineTypes REST client with a custom
              # configuration:
              #
              ...
              def aggregated_list request, options = nil
                ...
                @machine_types_stub.aggregated_list request, options: options do |response, env|
              ...
              def get request, options = nil
                ...
                @machine_types_stub.get request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              def list request, options = nil
                ...
                @machine_types_stub.list request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
