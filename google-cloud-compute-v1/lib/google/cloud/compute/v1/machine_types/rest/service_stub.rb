      ...
      module V1
        module MachineTypes
          module Rest
            ...
            class ServiceStub
              ##
              # Create a new MachineTypes REST service stub object.
              #
              ...
              def aggregated_list request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::AggregatedListMachineTypesRequest.encode_json(request_pb)
                ...
                ::Google::Cloud::Compute::V1::MachineTypeAggregatedList.decode_json result_json[:body], { ignore_unknown_fields: true }
              end
              ...
              def get request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::GetMachineTypeRequest.encode_json(request_pb)
                ...
                ::Google::Cloud::Compute::V1::MachineType.decode_json result_json[:body], { ignore_unknown_fields: true }
              end
              ...
              def list request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::ListMachineTypesRequest.encode_json(request_pb)
                ...
                ::Google::Cloud::Compute::V1::MachineTypeList.decode_json result_json[:body], { ignore_unknown_fields: true }
              end
            end
          end
        end
