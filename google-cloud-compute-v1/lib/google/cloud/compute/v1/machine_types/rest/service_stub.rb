          ...
          module Rest
            ...
            class ServiceStub
              ...
              def aggregated_list request_pb, options:, &block
                ...
                ::Google::Cloud::Compute::V1::MachineTypeAggregatedList.decode_json result_json[:body]
              end
              ...
              def get request_pb, options:, &block
                ...
                ::Google::Cloud::Compute::V1::MachineType.decode_json result_json[:body]
              end
              ...
              def list request_pb, options:, &block
                ...
                ::Google::Cloud::Compute::V1::MachineTypeList.decode_json result_json[:body]
              end
            end
          end
        end
