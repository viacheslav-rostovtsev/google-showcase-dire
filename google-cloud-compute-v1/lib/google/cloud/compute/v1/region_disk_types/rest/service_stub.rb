      ...
      module V1
        module RegionDiskTypes
          module Rest
            ...
            class ServiceStub
              ##
              # Create a new RegionDiskTypes REST service stub object.
              #
              ...
              def get request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::GetRegionDiskTypeRequest.encode_json(request_pb)
              ...
              def list request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::ListRegionDiskTypesRequest.encode_json(request_pb)
                ...
                ::Google::Cloud::Compute::V1::RegionDiskTypeList.decode_json result_json[:body], { ignore_unknown_fields: true }
              end
            end
          end
        end
