        ...
        module GlobalAddresses
          module Rest
            ...
            class Client
              ...
              # ## Examples
              #
              # To create a new GlobalAddresses REST client with the default
              # configuration:
              #
              #     client = ::Google::Cloud::Compute::V1::GlobalAddresses::Rest::Client.new
              #
              # To create a new GlobalAddresses REST client with a custom
              # configuration:
              #
              ...
              def delete request, options = nil
                ...
                @global_addresses_stub.delete request, options: options do |response, env|
              ...
              def get request, options = nil
                ...
                @global_addresses_stub.get request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def insert request, options = nil
                ...
                @global_addresses_stub.insert request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def list request, options = nil
                ...
                @global_addresses_stub.list request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
