          ...
          module Rest
            ...
            class Client
              ...
              def delete request, options = nil
                ...
                @region_network_endpoint_groups_stub.delete request, options: options do |response, env|
              ...
              def get request, options = nil
                ...
                @region_network_endpoint_groups_stub.get request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def insert request, options = nil
                ...
                @region_network_endpoint_groups_stub.insert request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def list request, options = nil
                ...
                @region_network_endpoint_groups_stub.list request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
