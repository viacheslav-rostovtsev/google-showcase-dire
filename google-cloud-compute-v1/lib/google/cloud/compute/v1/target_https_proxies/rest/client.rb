          ...
          module Rest
            ...
            class Client
              ...
              def aggregated_list request, options = nil
                ...
                @target_https_proxies_stub.aggregated_list request, options: options do |response, env|
              ...
              def delete request, options = nil
                ...
                @target_https_proxies_stub.delete request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              def get request, options = nil
                ...
                @target_https_proxies_stub.get request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              def insert request, options = nil
                ...
                @target_https_proxies_stub.insert request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              def list request, options = nil
                ...
                @target_https_proxies_stub.list request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              def set_quic_override request, options = nil
                ...
                @target_https_proxies_stub.set_quic_override request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              def set_ssl_certificates request, options = nil
                ...
                @target_https_proxies_stub.set_ssl_certificates request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              def set_ssl_policy request, options = nil
                ...
                @target_https_proxies_stub.set_ssl_policy request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              def set_url_map request, options = nil
                ...
                @target_https_proxies_stub.set_url_map request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
