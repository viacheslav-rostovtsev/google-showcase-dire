          ...
          module Rest
            ...
            class Client
              ...
              def delete request, options = nil
                ...
                @target_grpc_proxies_stub.delete request, options: options do |response, env|
              ...
              def get request, options = nil
                ...
                @target_grpc_proxies_stub.get request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def insert request, options = nil
                ...
                @target_grpc_proxies_stub.insert request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def list request, options = nil
                ...
                @target_grpc_proxies_stub.list request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def patch request, options = nil
                ...
                @target_grpc_proxies_stub.patch request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
