          ...
          module Rest
            ...
            class ServiceStub
              ...
              def delete request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::DeleteLicenseRequest.encode_json(request_pb)
              ...
              def get request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::GetLicenseRequest.encode_json(request_pb)
              ...
              def get_iam_policy request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::GetIamPolicyLicenseRequest.encode_json(request_pb)
              ...
              def insert request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::InsertLicenseRequest.encode_json(request_pb)
              ...
              def list request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::ListLicensesRequest.encode_json(request_pb)
              ...
              def set_iam_policy request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::SetIamPolicyLicenseRequest.encode_json(request_pb)
              ...
              def test_iam_permissions request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::TestIamPermissionsLicenseRequest.encode_json(request_pb)
