        ...
        module RegionTargetHttpsProxies
          module Rest
            ...
            class Client
              ...
              #
              # To create a new RegionTargetHttpsProxies REST client with a custom
              # configuration:
              #
              ...
              def initialize
                ...
                @region_target_https_proxies_stub = ::Google::Cloud::Compute::V1::RegionTargetHttpsProxies::Rest::ServiceStub.new(
              ...
              def delete request, options = nil
                ...
                @region_target_https_proxies_stub.delete request, options: options do |response, env|
              ...
              def get request, options = nil
                ...
                @region_target_https_proxies_stub.get request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              def insert request, options = nil
                ...
                @region_target_https_proxies_stub.insert request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              def list request, options = nil
                ...
                @region_target_https_proxies_stub.list request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              def set_ssl_certificates request, options = nil
                ...
                @region_target_https_proxies_stub.set_ssl_certificates request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
              ...
              def set_url_map request, options = nil
                ...
                @region_target_https_proxies_stub.set_url_map request, options: options do |response, env|
                  yield response, env if block_given?
                end
              rescue ::Faraday::Error => e
                ::Gapic::Rest::ErrorWrap.augment_faraday_error! e
