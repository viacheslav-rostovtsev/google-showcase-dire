          ...
          module Rest
            ...
            class ServiceStub
              ...
              def delete request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::DeleteGlobalForwardingRuleRequest.encode_json(request_pb)
              ...
              def get request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::GetGlobalForwardingRuleRequest.encode_json(request_pb)
                ...
                ::Google::Cloud::Compute::V1::ForwardingRule.decode_json result_json[:body]
              end
              ...
              def insert request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::InsertGlobalForwardingRuleRequest.encode_json(request_pb)
              ...
              def list request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::ListGlobalForwardingRulesRequest.encode_json(request_pb)
                ...
                ::Google::Cloud::Compute::V1::ForwardingRuleList.decode_json result_json[:body]
              end
              ...
              def patch request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::PatchGlobalForwardingRuleRequest.encode_json(request_pb)
              ...
              def set_target request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::SetTargetGlobalForwardingRuleRequest.encode_json(request_pb)
