          ...
          module Rest
            ...
            class ServiceStub
              ...
              def aggregated_list request_pb, options:, &block
                ...
                ::Google::Cloud::Compute::V1::InstanceGroupManagerAggregatedList.decode_json result_json[:body]
              end
              ...
              def get request_pb, options:, &block
                ...
                ::Google::Cloud::Compute::V1::InstanceGroupManager.decode_json result_json[:body]
              end
              ...
              def list request_pb, options:, &block
                ...
                ::Google::Cloud::Compute::V1::InstanceGroupManagerList.decode_json result_json[:body]
              end
              ...
              def list_errors request_pb, options:, &block
                ...
                ::Google::Cloud::Compute::V1::InstanceGroupManagersListErrorsResponse.decode_json result_json[:body]
              end
              ...
              def list_managed_instances request_pb, options:, &block
                ...
                ::Google::Cloud::Compute::V1::InstanceGroupManagersListManagedInstancesResponse.decode_json result_json[:body]
              end
              ...
              def list_per_instance_configs request_pb, options:, &block
                ...
                ::Google::Cloud::Compute::V1::InstanceGroupManagersListPerInstanceConfigsResp.decode_json result_json[:body]
              end
