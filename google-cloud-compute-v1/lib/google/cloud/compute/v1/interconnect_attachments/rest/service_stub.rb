          ...
          module Rest
            ...
            class ServiceStub
              ...
              def aggregated_list request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::AggregatedListInterconnectAttachmentsRequest.encode_json(request_pb)
                ...
                ::Google::Cloud::Compute::V1::InterconnectAttachmentAggregatedList.decode_json result_json[:body]
              end
              ...
              def delete request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::DeleteInterconnectAttachmentRequest.encode_json(request_pb)
              ...
              def get request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::GetInterconnectAttachmentRequest.encode_json(request_pb)
                ...
                ::Google::Cloud::Compute::V1::InterconnectAttachment.decode_json result_json[:body]
              end
              ...
              def insert request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::InsertInterconnectAttachmentRequest.encode_json(request_pb)
              ...
              def list request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::ListInterconnectAttachmentsRequest.encode_json(request_pb)
                ...
                ::Google::Cloud::Compute::V1::InterconnectAttachmentList.decode_json result_json[:body]
              end
              ...
              def patch request_pb, options:, &block
                request_json = JSON.parse ::Google::Cloud::Compute::V1::PatchInterconnectAttachmentRequest.encode_json(request_pb)
